...
#
# Script generated by Vivado on Sat Jun 22 22:27:57 +0900 2024
...
# script info
echo -e "fifo_16x8.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_16x8 xil_defaultlib.fifo_16x8 xil_defaultlib.glbl -log elaborate.log
}
