...
HD_PWD='C:/Harman/Verilog/SoC_07_16_Project_prac/SoC_07_16_Project_prac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Servo_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Servo_interface.tcl -notrace
