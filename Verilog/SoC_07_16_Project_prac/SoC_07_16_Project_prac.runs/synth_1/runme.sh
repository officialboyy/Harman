...
HD_PWD='C:/Harman/Verilog/SoC_07_16_Project_prac/SoC_07_16_Project_prac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Servo_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Servo_interface.tcl
