...
HD_PWD='C:/Harman/Verilog/SoC_07_15_blaze_w5500_rev/SoC_07_15_blaze_w5500_rev.runs/system_reset_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_reset_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_reset_inv_0_0.tcl
