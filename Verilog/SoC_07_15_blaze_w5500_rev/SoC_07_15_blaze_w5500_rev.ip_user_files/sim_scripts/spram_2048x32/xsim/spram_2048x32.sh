...
#
# Script generated by Vivado on Mon Jul 15 14:04:36 +0900 2024
...
# script info
echo -e "spram_2048x32.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram_2048x32 xil_defaultlib.spram_2048x32 xil_defaultlib.glbl -log elaborate.log
}
