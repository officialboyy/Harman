...
HD_PWD='C:/Harman/Verilog/SoC_06_16_prac/SoC_06_16_prac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_con_exam_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_con_exam_IP_wrapper.tcl -notrace
