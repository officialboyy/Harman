...
HD_PWD='C:/Harman/Verilog/SoC_06_16_prac/SoC_06_16_prac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_con_exam_IP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_con_exam_IP_wrapper.tcl
