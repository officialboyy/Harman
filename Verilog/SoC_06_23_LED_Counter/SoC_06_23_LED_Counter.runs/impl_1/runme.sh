...
HD_PWD='C:/Harman/Verilog/SoC_06_23_LED_Counter/SoC_06_23_LED_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlazeTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlazeTop.tcl -notrace
