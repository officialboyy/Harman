...
HD_PWD='C:/Harman/Verilog/SoC_06_23_LED_Counter/SoC_06_23_LED_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlazeTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlazeTop.tcl
