...
HD_PWD='C:/Harman/Verilog/SoC_07_23_servo_axi/SoC_07_23_servo_axi.runs/servo_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_microblaze_0_1.tcl
