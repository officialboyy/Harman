...
HD_PWD='C:/Harman/Verilog/SoC_07_23_servo_axi/SoC_07_23_servo_axi.runs/servo_servo_axi_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_servo_axi_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_servo_axi_0_4.tcl
