...
HD_PWD='C:/Harman/Verilog/SoC_06_20_blaze_w5500/SoC_06_20_blaze_w5500.runs/system_axi_uartlite_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_uartlite_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_uartlite_0_1.tcl
