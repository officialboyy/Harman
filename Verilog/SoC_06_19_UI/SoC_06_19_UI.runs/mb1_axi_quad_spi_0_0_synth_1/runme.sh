...
HD_PWD='C:/Harman/Verilog/SoC_06_19_UI/SoC_06_19_UI.runs/mb1_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb1_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb1_axi_quad_spi_0_0.tcl
