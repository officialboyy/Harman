...
#define eth_reset(flag)  	Xil_Out32(XPAR_BRAM_1_BASEADDR+rETH_CTRL, (Xil_In32(XPAR_BRAM_1_BASEADDR+rETH_CTRL) & ~0x4) | (flag<<2))
#define eth_ram_sel(flag)  	Xil_Out32(XPAR_BRAM_1_BASEADDR+rETH_CTRL, (Xil_In32(XPAR_BRAM_1_BASEADDR+rETH_CTRL) & ~0x2) | (flag<<1))
#define eth_start(flag)  	Xil_Out32(XPAR_BRAM_1_BASEADDR+rETH_CTRL, (Xil_In32(XPAR_BRAM_1_BASEADDR+rETH_CTRL) & ~0x1) | (flag<<0))
#define eth_addr(addr)  	Xil_Out32(XPAR_BRAM_1_BASEADDR+rETH_ADDR, addr)
#define eth_size(size)  	Xil_Out32(XPAR_BRAM_1_BASEADDR+rETH_SIZE, size)
#define eth_done()          (Xil_In32(XPAR_BRAM_1_BASEADDR+rETH_CTRL) & 0x10)
...
extern uint8_t   tcpRxBuffer[TCP_BUF_MAX];
extern uint8_t   tcpTxBuffer[TCP_BUF_MAX];
