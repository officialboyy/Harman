...
volatile uint32_t light_intensity_value = 0;
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if(Temperature > 25) {
		  htim1.Instance->CCR3 = 50000;		// Water Pump ON
	  }
	  else{
		  htim1.Instance->CCR3 = 0;			// Water Pump OFF
	  }
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  /*
	  printf("토양습도:%.2f \r\n 변환이전 값: %.2f \r\n 조도값: %d\r\n", ground_humid, soil_moisture_value, lux);
